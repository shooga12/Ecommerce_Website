...
def sales(request):
    ...
    return render(request, 'myapp/sales.html', {'total_sales': total_sales, 'yearly_sales': yearly_sales, 'monthly_sales': monthly_sales, 'weekly_sales':weekly_sales, 'product_sales_sums':product_sales_sums})
